...
namespace ThirdParty
{
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            AddressDetails addressBookDetails = AddressDetails.GetFromFile();
            bool flag = true;
            while (flag)
            {
            ...
            string exportFilePath = @"C:\Users\K.R.DHASHNIGA\source\repos\ThirdParty\ThirdParty\Details.csv";
